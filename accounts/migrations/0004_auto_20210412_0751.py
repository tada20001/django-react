# Generated by Django 3.0.11 on 2021-04-11 22:51
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0003_auto_20210411_1012'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='user',
            name='avatar',
            field=models.ImageField(blank=True, help_text='48px * 48px 크기의 png/jpg 파일을 업로드해 주세요.', upload_to='accounts/profile/%Y/%m/%d'),
        ),
    ]
